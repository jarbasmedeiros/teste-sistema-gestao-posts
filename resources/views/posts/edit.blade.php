                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                           aria-describedby="titleHelpInline" value="{{ $post->title }}" name="title">
                                </div>
                                @error('title')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    name="description" aria-label="With textarea" value="">{{ $post->description }}</textarea>
                                </div>
                                @error('description')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('image_url') is-invalid @enderror"
                                           aria-describedby="image_urldHelpInline" value="{{ $post->image_url }}"
                                           name="image_url">
                                </div>
                                @error('image_url')
                                <p class="text-danger">{{ $message }}</p>
